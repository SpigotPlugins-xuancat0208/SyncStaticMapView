...
public interface CodeFunction {
    ...
    static <T> T copySQLPart(T o) {
        return o instanceof CodeSQLPart ? (T) ((CodeSQLPart) o).clone() : o;
    }
    static <T> T copySQLBuilder(T o) {
        return o instanceof CodeSQLBuilder ? (T) ((CodeSQLBuilder) o).clone() : o;
    }
...
//    }
    ...
    static List<String> split(String text, char breakpoint, Charset charset, int limit, Function<String, String> conversion) {
    ...
    static <T> T tryClone(T t) {
        ...
        } else if (t instanceof CodeSQLPart) {
            return copySQLPart(t);
        } else if (t instanceof CodeSQLBuilder) {
