...
//        }
    ...
    public void dismount(double d0, double d1, double d2, float f, float f1, PlayerTeleportEvent.TeleportCause cause) {
        connection.dismount(d0, d1, d2, f, f1, cause);
    }

    @Override
    public void teleport(double d0, double d1, double d2, float f, float f1, PlayerTeleportEvent.TeleportCause cause) {
        connection.teleport(d0, d1, d2, f, f1, cause);
    }
    ...
    public void teleport(double d0, double d1, double d2, float f, float f1, Set<PacketPlayOutPosition.EnumPlayerTeleportFlags> set, PlayerTeleportEvent.TeleportCause cause) {
        connection.teleport(d0, d1, d2, f, f1, set, cause);
    }
    ...
    @Override
    public boolean teleport(double d0, double d1, double d2, float f, float f1, Set<PacketPlayOutPosition.EnumPlayerTeleportFlags> set, boolean flag, PlayerTeleportEvent.TeleportCause cause) {
        return connection.teleport(d0, d1, d2, f, f1, set, flag, cause);
    }
    ...
    @Override
    public void onDisconnect(IChatBaseComponent reason, Component quitMessage) {
