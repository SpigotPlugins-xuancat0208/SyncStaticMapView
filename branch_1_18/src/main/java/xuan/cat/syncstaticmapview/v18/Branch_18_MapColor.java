...
public final class Branch_18_MapColor implements BranchMapColor {
    ...
    public Branch_18_MapColor() {
        ...
        colorRegistry.add(new Color(152, 123, 103));  // 240
        colorRegistry.add(new Color(186, 150, 126));  // 241
        colorRegistry.add(new Color(216, 175, 147));  // 242
        colorRegistry.add(new Color(114, 92,  77));   // 243

        colorRegistry.add(new Color(89,  117, 105));  // 244
        colorRegistry.add(new Color(109, 144, 129));  // 245
        colorRegistry.add(new Color(127, 167, 150));  // 246
        colorRegistry.add(new Color(67,  88,  79));   // 247
        ...
        for (int r = 0 ; r < 64 ; r ++)
            for (int g = 0 ; g < 64 ; g ++)
                for (int b = 0 ; b < 64 ; b ++) {
                    ...
                    Color   colorA;
                    Color   colorB;
                    for (int colorID = 0; colorID < registryColorAmount; colorID++) {
